...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed top-0 left-0 z-30 h-screen bg-white shadow-xl
      ...
      >
        <button
          ...
          className="absolute top-4 right-3 bg-white p-2 rounded-full shadow z-40"
        >
          {sidebarOpen ? (
        ...
        <ul className="flex flex-col gap-4 mt-20 px-3">
          <NavLink to="/teachers">
            <li
              className={`
                flex items-center p-3 rounded-xl border font-bold
          ...
          <li
            onClick={Logout}
            className={`
              flex items-center p-3 rounded-xl border font-bold cursor-pointer
              ${sidebarOpen ? "gap-3 justify-start" : "justify-center"}
